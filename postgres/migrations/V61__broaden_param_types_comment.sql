...
--
-- Two gaps found comparing ParamTypes.CURATED (application source of truth)
...
--   2. The academico_test DOMAIN types (BOOL_SN, ESTADO_AI, ESTADO_AC,
...
COMMENT ON COLUMN QUERY.PARAM_TYPES IS
    ...
    'TEXT[],BIGINT[],INTEGER[],NUMERIC[],BOOLEAN[],TIME[],DATE[],TIMESTAMP[],TIMESTAMPTZ[],'
