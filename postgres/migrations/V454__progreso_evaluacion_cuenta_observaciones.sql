-- ===========================================================================
-- V454 — el progreso de evaluacion cuenta las observaciones.
--
-- Que hace: fn_actividad_listar (estudiantes_evaluados / porcentaje_evaluado,
-- lo que pinta "n/m estudiantes evaluados" en el tablero y en /actividades/mias)
-- y fn_planilla_columnas_listar (estudiantes_calificados) solo contaban la
-- nota numerica. Una actividad formativa/preescolar se evalua con OBSERVACION y
-- CALIFICACION NULL (V243), asi que mostraba 0 evaluados con todos observados.
-- Se adopta la regla que fn_actividad_finalizacion_refrescar ya usaba: nota, o
-- OBSERVACION no vacia con CALIFICABLE = N.
-- Por que aqui: migracion nueva para no re-ejecutar V224/V441 y sus arrastres.
-- Depende de: V224 y V441 (cuerpos base), V243 (regla de la observacion).
-- ===========================================================================

SET search_path TO academico_test, public;

-- Firmas y RETURNS TABLE intactos en las dos: CREATE OR REPLACE, sin DROP.
