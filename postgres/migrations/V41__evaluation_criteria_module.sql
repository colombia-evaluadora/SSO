...
CREATE OR REPLACE FUNCTION academico_test.fn_criterio_eval_actualizar(p_pk_periodo bigint, p_grading_format bigint DEFAULT NULL::bigint, p_grading_scale bigint DEFAULT NULL::bigint, p_set_grading_scale boolean DEFAULT false, p_period_calc_elements bigint DEFAULT NULL::bigint, p_modif_final_peraca bigint DEFAULT NULL::bigint, p_subject_grade_criteria bigint DEFAULT NULL::bigint, p_final_grade_criteria bigint DEFAULT NULL::bigint, p_area_grade_criteria bigint DEFAULT NULL::bigint, p_student_wo_grades bigint DEFAULT NULL::bigint, p_rounding_mode bigint DEFAULT NULL::bigint, p_initial_grade numeric DEFAULT NULL::numeric, p_max_recovery_grade numeric DEFAULT NULL::numeric, p_pk_usuario_solicitante bigint DEFAULT NULL::bigint)
 RETURNS bigint
 LANGUAGE plpgsql
AS $function$
DECLARE
