...
DECLARE
    ...
    v_perm            RECORD;
    v_pnombre_actual  VARCHAR; v_snombre_actual VARCHAR;
    v_papellido_actual VARCHAR; v_sapellido_actual VARCHAR;
BEGIN
    -- =====================================================================
    ...
    -- Nombre actual (para la etiqueta de auditoria; declarada una sola vez,
    -- cubre tanto el UPDATE de TUSUARIO como el de TFUNCIONARIO mas abajo,
    -- ya que nada mas en esta funcion vuelve a llamar fn_audit_declarar).
