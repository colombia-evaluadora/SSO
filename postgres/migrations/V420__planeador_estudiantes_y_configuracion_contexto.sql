-- ===========================================================================
-- V420 — Planeador: los estudiantes de una actividad y la configuracion de la
...
-- V353 -> V420. V420 va en el MISMO despliegue que V224: fn_actividad_crear/
-- _actualizar llaman a fn_actividad_programacion_assert, que define V420 (42883).
-- ===========================================================================
