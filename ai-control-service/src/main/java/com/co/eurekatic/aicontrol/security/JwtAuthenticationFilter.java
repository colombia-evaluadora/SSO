 ...
 * homonimos de reporting-service, query-service y sso-admin.
 *
 * <p>Ademas de autenticar, deja el token crudo como {@code credentials}
 * de la {@code Authentication}. Eso no es un detalle: el servicio no
 * consulta la base con una identidad de servicio, sino que le reenvia
 * ESTE token al query-service. Si el token no viajara, este servicio
